...
namespace Characters {
    static class Player {
        ...
        public static void Create (Transform transformIn) {
            ...
            player.Properties.SetResource(CharacterResource.Type.Stamina, new CharacterResource(100, Color.yellow, 1f));
            player.Properties.SetResource(CharacterResource.Type.Mana, new CharacterResource(100, Color.blue, 1f));
        ...
        private static void SetupActions (ref Character player) {
            ...
            ActionEvent[] invulnerabilityEvents = {  new ActionEvent(ActionEvent.ActionPhase.PreAction, StaticEvents.DisableInvulnerability),
            ...
            ComboAction attack1ending = new ComboAction (new Idle (player, player.Animation.GetClip ("Player_Attack_Ender").length, player.Animation.GetClip ("Player_Attack_Ender"), 1),
                                                         ...
                                                         new CharacterActionSequence(player, player.Animation.GetClip("Player_Attack_2"), null,
                                                            ...
                                                            new Idle(player, attack2duration*20 / 161, null, 1, null, attackEvents[0], attackEvents[1], invulnerabilityEvents[0]),
